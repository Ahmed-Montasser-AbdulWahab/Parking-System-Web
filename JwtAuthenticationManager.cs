...
namespace Parking_System
{
    ...
    {
        public JwtAuthenticationResponse AuthenticateCustomer(string userName, string password)
        {
        ...
        public JwtAuthenticationResponse AuthenticateAdminAndOpertor(string Email, string password)
        {
            AppDbContext dbContext = new AppDbContext();
            //Validating the User Name and Password
            var role = dbContext.FindSystemUser(Email, password);
